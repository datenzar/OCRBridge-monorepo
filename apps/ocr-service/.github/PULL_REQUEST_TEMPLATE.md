...
<!-- Paste test coverage output if relevant -->
...
- [ ] `pyright` type checking passes with no new errors
...
<!-- Note any deployment considerations, migration steps, or configuration changes -->
...
- [ ] I understand this project is licensed under GPL-3.0
